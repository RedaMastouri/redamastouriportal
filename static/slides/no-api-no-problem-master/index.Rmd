...
author: "<br>Reda Mastouri<br><i class='fab fa-twitter' style='color:#6CADDE'></i><i class='fab fa-github'></i> @redamastouri"
date: "slides at [github.com/redamastouri/no-api-no-problem](https://github.com/redamastouri/no-api-no-problem)"
output:
